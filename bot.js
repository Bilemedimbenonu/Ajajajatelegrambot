...
try {
var res = await axios.get(BINANCE_BASE + path, {
...
var data = await binanceGet(”/fapi/v1/klines”, { symbol: symbol, interval: interval, limit: limit || 100 });
...
var data = await binanceGet(”/fapi/v1/premiumIndex”, { symbol: symbol });
if (!data) return null;
return parseFloat(data.lastFundingRate || 0);
}

async function fetchTicker(symbol) {
var data = await binanceGet(”/fapi/v1/ticker/price”, { symbol: symbol });
...
var emoji = direction === “long” ? “[LONG]” : “[SHORT]”;
var lev   = 20;
...
var bar     = “X”.repeat(score) + “.”.repeat(6 - score);
var tier    = score >= 6 ? “MUKEMMEL” : score === 5 ? “GUCLU” : “IYI”;

return (
“<b>” + emoji + “ “ + symbol + “</b>  [” + signalNo + “/” + PARAMS.MAX_DAILY + “]\n” +
“————————\n” +
“<b>Giris:</b> “ + fmtPrice(price) + “\n\n” +
“<b>TP1:</b> “ + fmtPrice(levels.tp1) + “  (+” + tp1Pct + “% | 20x:+%” + tp120 + “) %40\n” +
“<b>TP2:</b> “ + fmtPrice(levels.tp2) + “  (+” + tp2Pct + “% | 20x:+%” + tp220 + “) %40\n” +
“<b>TP3:</b> “ + fmtPrice(levels.tp3) + “  (+” + tp3Pct + “% | 20x:+%” + tp320 + “) %20\n” +
“<b>SL:</b>  “ + fmtPrice(levels.sl) + “  (-” + slPct + “% | 20x:-%” + sl20 + “)\n” +
“————————\n” +
“Skor: “ + bar + “ <b>” + score + “/6</b>  “ + tier + “\n” +
“<code>” + hits.join(” | “) + “</code>\n” +
“R:R: 1:” + rr + “ | Funding: “ + fundStr + “\n” +
“————————\n” +
“Multi-Confluence | London+NY\n” +
“————————\n” +
“<i>Mum KAPANISINI bekle!\n” +
“TP1 de %40 kapat, SL yi girise cek!\n” +
“2 stop = O GUN BIT!</i>\n” +
now + “\n” +
...
for (var d = 0; d < 2; d++) {
  ...
  if (FILTERS.BB       && checkBB(c15m, direction))       { score++; hits.push("BB"); }
...
console.log(”  Max sinyal: “ + PARAMS.MAX_DAILY + “ | Min skor: “ + PARAMS.MIN_SCORE + “/6”);
...
“Max sinyal: “ + PARAMS.MAX_DAILY + “/gun\n\n” +
“Filtreler: TREND | MACD | RSI | VOL | CVD | BB\n\n” +
